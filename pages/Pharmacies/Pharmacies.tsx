...
const Pharmacies: React.FC = () => {
  ...
  return (
    <div className="bg-green-100 p-4 min-h-screen">
      ...
      <img
  src="../assets/images/logo-unisante.jpg"
  alt="Profil"
  className="absolute top-2 right-0 mr-8 w-18 h-16 rounded-full shadow-lg"
/>



      {/* Conteneur principal avec trois colonnes */}
      <div className="flex mt-6 justify-between gap-x-8">
        ...
        <div className="flex-1 mx-4 ">
          <div className="space-y-6">
            {currentPharmacies.length > 0 ? (
              ...
              <p className="text-center text-gray-600">Aucune pharmacie trouvée autour de vous sur un rayon de 5km.</p>
            )}
          </div>
          {/* Pagination */}
